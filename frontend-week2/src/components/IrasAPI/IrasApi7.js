...
const IrasApi7 = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await axios.post('http://localhost:8000/iras7', formData);
  ...
  return (
    <div className="container mt-5">
      <h1 className="mb-4">Residential Seller Stamp Duty</h1>
      ...
      {response && (
        <div className="mt-5">
          ...
          <p>Holding Period: {response.data.holdingPeriod}</p>
